<link rel="stylesheet" href="play/scripts/jquery-ui/jquery-ui.css">
<script src="play/scripts/jquery-ui/jquery-ui.js"></script>
<?php
...
$table_meta = array(
	...
	'caption' => '<div id ="caption">Current Games</div>' ,
);
$table_format = array(
	...
	array('Map', '<img src="images/board.jpg" class="thumb" alt="world_classic" width="114" height="75"title="world classic">') ,
