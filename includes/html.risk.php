	...
	<div id="game_info">
		...
		<?php
			...
			$ra_table_format = array(
				...
				array('Phase', 'state', 'text') ,
				array('Round', 'round', 'digit') ,
				array('Turn', 'turn', 'digit') ,
				array('Armies', 'armies', 'digitmissing') ,
				array('Lands', 'land', 'digitmissing') ,
				array('Regions Owned', 'cont_list', 'digitmissing') ,
				array('Cards', 'card_count', 'digitmissing') ,
			//	array('% trade', 'trade_perc', 'percentmissing') ,
				array('Reinforcements', '[[[next_armies]]] / [[[next_armies_trade]]]', 'nextturn') ,
			);
